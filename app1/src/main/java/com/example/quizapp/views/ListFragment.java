...
public class ListFragment extends Fragment implements QuizListAdapter.OnItemClickedListner {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, ViewModelProvider.AndroidViewModelFactory
                .getInstance(requireActivity().getApplication())).get(QuizListViewModel.class);
    }
    ...
    public void onItemClick(int position) {
        ActionListFragmentToDetailFragment action;
        action = ListFragmentDirections.actionListFragmentToDetailFragment(position);
